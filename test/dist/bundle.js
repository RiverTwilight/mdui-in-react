...
/******/ 	return __webpack_require__(__webpack_require__.s = "./test/src/index.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
var __assign = undefined && undefined.__assign || function () {
    __assign = _assign2.default || function (t) {
...
var Input = function Input(_a) {
    var error = _a.error,
        ...
        others = __rest(_a, ["error", "helper", "icon", "rows", "header", "placeholder", "value", "onValueChange"]);
    var TagType = rows ? 'textarea' : 'input';
    return React.createElement("div", { className: "mdui-textfield " + (placeholder ? '' : 'mdui-textfield-floating-label') }, icon && React.createElement("i", { className: "mdui-icon material-icons" }, icon), header && React.createElement("label", { className: "mdui-textfield-label" }, header), React.createElement(TagType, __assign({}, others, { placeholder: placeholder, rows: rows, onChange: function onChange(e) {
            onValueChange(e.target.value);
        }, value: value, className: "mdui-textfield-input" })), error && React.createElement("div", { className: "mdui-textfield-error" }, error), helper && React.createElement("div", { className: "mdui-textfield-helper" }, helper));
};
exports.default = Input;

/***/ }),

/***/ "./built/ListControlMenu.js":
/*!**********************************!*\
  !*** ./built/ListControlMenu.js ***!
  \**********************************/
/*! no static exports found */
...
var Dialog = function Dialog(_a) {
    var items = _a.items,
        ...
        title = _a.title,
        checked = _a.checked;
    return React.createElement("div", { className: "mdui-dialog", id: "list" }, React.createElement("div", { className: "mdui-dialog-title" }, title), React.createElement("div", { className: "mdui-dialog-content" }, React.createElement("ul", { className: "mdui-list" }, items.map(function (item, i) {
        return React.createElement("label", { key: item.title, "mdui-dialog-close": "true", className: "mdui-list-item mdui-ripple" }, React.createElement("div", { className: "mdui-radio" }, React.createElement("input", { onChange: function onChange(_) {
                return onCheckedChange(i);
            }, type: "radio", key: i, checked: items[checked].value === item.value }), React.createElement("i", { className: "mdui-radio-icon" })), React.createElement("div", { className: "mdui-list-item-content" }, item.name));
    }))), React.createElement("div", { className: "mdui-dialog-actions" }, React.createElement("button", { "mdui-dialog-close": "true", className: "mdui-btn mdui-ripple" }, "\u53D6\u6D88")));
};
exports.default = function (_a) {
    var checked = _a.checked,
        items = _a.items,
        _b = _a.title,
        title = _b === void 0 ? "请选择" : _b,
        onCheckedChange = _a.onCheckedChange,
        _c = _a.icon,
        icon = _c === void 0 ? "setting" : _c;
    return React.createElement(React.Fragment, null, React.createElement("li", { "mdui-dialog": "{target:'#list',history:false}", className: "mdui-list-item mdui-ripple" }, React.createElement("i", { className: "mdui-list-item-icon mdui-icon material-icons" }, icon), React.createElement("div", { className: "mdui-list-item-content" }, React.createElement("div", { className: "mdui-list-item-title mdui-list-item-one-line" }, title), React.createElement("div", { className: "mdui-list-item-text mdui-list-item-one-line" }, items[checked].name))), React.createElement(Dialog, { checked: checked, title: title, onCheckedChange: onCheckedChange, items: items }));
};
...
module.exports = { "default": __webpack_require__(/*! core-js/library/fn/object/get-own-property-symbols */ "./node_modules/babel-runtime/node_modules/core-js/library/fn/object/get-own-property-symbols.js"), __esModule: true };
...
var ListControlMenu_1 = __webpack_require__(/*! ../../built/ListControlMenu */ "./built/ListControlMenu.js");
var Input_1 = __webpack_require__(/*! ../../built/Input */ "./built/Input.js");
var menu_types = [{
    name: '通用物体和场景',
    value: 'normal'
}, {
...
var Ui = /** @class */function (_super) {
    ...
    Ui.prototype.render = function () {
        ...
        var _a = this.state,
            checked = _a.checked,
            inputText = _a.inputText,
            menu_type = _a.menu_type,
            SelectorValue = _a.SelectorValue;
        return React.createElement(React.Fragment, null, React.createElement(Input_1.default, { onValueChange: function onValueChange(newText) {
                _this.setState({ inputText: newText });
            }, value: inputText, header: "\u8F93\u5165\u5185\u5BB9", icon: "link", error: "\u8FD9\u662F\u4E00\u4E2A\u53EF\u9009\u7684\u9519\u8BEF\u4FE1\u606F", type: "number" }), React.createElement(ListControlMenu_1.default, { icon: "language", title: "\u8BC6\u522B\u7C7B\u578B", checked: menu_type, onCheckedChange: function onCheckedChange(checked) {
                _this.setState({ menu_type: checked });
            }, items: menu_types }));
    };
    return Ui;
}(React.Component);
ReactDOM.render(React.createElement(Ui, null), document.getElementById('root'));
